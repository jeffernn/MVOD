            ...
            <nav className='px-2 mt-4 space-y-1'>
              ...
              >
                <div className='w-4 h-4 flex items-center justify-center'>
                  <Home className='h-4 w-4 text-gray-500 group-hover:text-blue-400 data-[active=true]:text-blue-500 dark:text-gray-400 dark:group-hover:text-blue-300 dark:data-[active=true]:text-blue-300' />
                </div>
                {!isCollapsed && (
              ...
              >
                <div className='w-4 h-4 flex items-center justify-center'>
                  <Search className='h-4 w-4 text-gray-500 group-hover:text-blue-400 data-[active=true]:text-blue-500 dark:text-gray-400 dark:group-hover:text-blue-300 dark:data-[active=true]:text-blue-300' />
                </div>
                {!isCollapsed && (
                  <span className='whitespace-nowrap transition-opacity duration-200 opacity-100'>
                    搜索
                ...
                {menuItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`group flex items-center rounded-lg px-2 py-2 pl-4 text-sm text-gray-700 hover:bg-gray-100/30 hover:text-blue-400 data-[active=true]:bg-blue-400/20 data-[active=true]:text-blue-500 transition-colors duration-200 min-h-[40px] dark:text-gray-300 dark:hover:text-blue-300 dark:data-[active=true]:bg-blue-400/10 dark:data-[active=true]:text-blue-300 ${
                        isCollapsed ? 'w-full max-w-none mx-0' : 'mx-0'
                      } gap-3 justify-start`}
                    >
                      <div className='w-4 h-4 flex items-center justify-center'>
                        <Icon className='h-4 w-4 text-gray-500 group-hover:text-blue-400 data-[active=true]:text-blue-500 dark:text-gray-400 dark:group-hover:text-blue-300 dark:data-[active=true]:text-blue-300' />
                      </div>
                      {!isCollapsed && (
                        <span className='whitespace-nowrap transition-opacity duration-200 opacity-100'>
                          {item.label}
