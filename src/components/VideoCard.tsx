    ...
    >
      ...
      <div className='relative aspect-[2/3] overflow-hidden rounded-lg'>
        ...
        {config.showPlayButton && (
          <div className='absolute inset-0 flex items-center justify-center opacity-0 transition-all duration-300 ease-in-out delay-75 group-hover:opacity-100 group-hover:scale-100'>
            <PlayCircleIcon
              size={50}
              strokeWidth={0.8}
              className='text-white fill-transparent transition-all duration-300 ease-out hover:fill-blue-400 hover:scale-[1.1]'
            />
          </div>
        )}
          ...
          <div className='absolute bottom-3 right-3 flex gap-3 opacity-0 translate-y-2 transition-all duration-300 ease-in-out group-hover:opacity-100 group-hover:translate-y-0'>
            {config.showCheckCircle && (
              <CheckCircle
                ...
                size={20}
                className='text-white transition-all duration-300 ease-out hover:stroke-blue-400 hover:scale-[1.1]'
              />
            )}
            {config.showHeart && (
              <Heart
        ...
        {config.showDoubanLink && actualDoubanId && actualDoubanId !== 0 && (
          ...
          >
            <div className='bg-blue-400 text-white text-xs font-bold w-7 h-7 rounded-full flex items-center justify-center shadow-md hover:bg-blue-400 hover:scale-[1.1] transition-all duration-300 ease-out'>
              <Link size={16} />
            </div>
          </a>
        )}
      ...
      <div className='mt-2 text-center'>
        <div className='relative'>
          <span className='block text-sm font-semibold truncate text-gray-900 dark:text-gray-100 transition-colors duration-300 ease-in-out group-hover:text-blue-400 dark:group-hover:text-blue-300 peer'>
            {actualTitle}
          </span>
          {/* 自定义 tooltip */}
        ...
        {config.showSourceName && source_name && (
          <span className='block text-xs text-gray-500 dark:text-gray-400 mt-1'>
            <span className='inline-block border rounded px-2 py-0.5 border-gray-500/60 dark:border-gray-400/60 transition-all duration-300 ease-in-out group-hover:border-blue-400/60 group-hover:text-blue-400 dark:group-hover:text-blue-300'>
              {source_name}
            </span>
          </span>
        )}
